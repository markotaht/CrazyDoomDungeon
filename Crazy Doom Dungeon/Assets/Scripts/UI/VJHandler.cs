//Originally from http://www.theappguruz.com/blog/beginners-guide-learn-to-make-simple-virtual-joystick-in-unity
...
public class VJHandler : MonoBehaviour, IDragHandler, IPointerUpHandler, IPointerDownHandler
{
    ...
    public void SetJoystickPosition(float x, float y)
    {
        ...
        position = Vector3.ClampMagnitude(position, jsContainer.rectTransform.sizeDelta.x/3);
